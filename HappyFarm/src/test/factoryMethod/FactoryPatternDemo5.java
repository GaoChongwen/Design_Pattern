...
public class FactoryPatternDemo5 {
    public static void main(String args[]){

        System.out.println("==========Factory_DEMO========");
        ...
        System.out.println("Factory:CouponFactor:addCoupon:Apple Coupon Created");
        CouponFactor.getInstance().add(PlantType.wheat.toString());
        System.out.println("Factory:CouponFactor:addCoupon:Wheat Coupon Created");
        CouponFactor.getInstance().add(PlantType.rice.toString());
        System.out.println("Factory:CouponFactor:addCoupon:Rice Coupon Created");
        CouponFactor.getInstance().add(PlantType.cabbage.toString());
        System.out.println("Factory:CouponFactor:addCoupon:Cabbage Coupon Created");
        CouponFactor.getInstance().add("super");
        System.out.println("Factory:CouponFactor:addCoupon:Super Coupon Created");
